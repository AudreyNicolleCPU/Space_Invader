...
class Mechant :
    ...
    def move(self,dy): 
        """
        Cette méthode permet de déplacaer horizontalement le méchant vers la 
    ...
    def tir (self,on_tir) :
        """ 
        Cette méthode permet de tirer des boules de feu. 
...
class M_bonus (Mechant) :
    ...
    def modif_caracteristique (self) :
        """
        Cette méthode permet de modifier les caractéristiques du mechant bonus
    ...
    def into_mechant (self) :
        """ 
        Cette méthode modifié l'image du mechant bonus et d'activer le tir 
        secret.
    ...
    def tir_secret (self, on_tir) :
        """
        Cette méthode permet de tirer les tir secret du mechant bonus. 
