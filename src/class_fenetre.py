...
class Fenetre :
    ...
    def about(self):
        """ 
        Cette méthode ouvre un fichier texte qui décrit le fonctionnement du 
        jeu.
    ...
    def principale(self):
        ...
        """ 
        Cette méthode permet de créer la fenêtre et faire appaître les widgets.
    ...
    def crea_ilots (self) : 
        """
        Cette méthode permet de créer 3 îlots composé de lignes de petits blocs.
    ...
    def gestion_tir_M_bonus(self) : 
        """
        Cette méthode permet de faire tirer le méchant bonus, soit avec son 
    ...
    def bad_daddy_is_comming(self) :
        """
        Cette méthode permet de mofifier la tête du mechant bonus quand il y a
        moins de mechant.
    ...
    def gestion_fin_de_vie_EHPHAD (self) :
        ...
        """
        Cette méthode permet de supprimer les éléments canvas nécessaires 
    ...
    def thermos_bu (self) : 
        """ 
        Cette méthode permet de faire appraître un carré rouge symbolisant 
    ...
    def fin_thermos (self) : 
        """ 
        Cette méthode permet d'enlever la fonction du thermos.
    ...
    def on_prepare_un_bonus (self) : 
        """
        Cette méthode permet de créer une bonne tartiflette à donner à Mr.Yeti
    ...
    def action_bonus (self) : 
        """
        Cette méthode permet de faire bouger les bonus, 
    ...
    def gestion_collisions(self):
        """
        Cette méthode permet de vérifier différents types de collisions
    ...
    def collision_ilot_projectile(self,projectile) :
        """
        Cette méthode permet de faire les actions nécessaires lorsqu'un projectile
    ...
    def collision(self,entite1, entite2,y):
        """ 
        Cette méthode permet de voir si deux objets rentrent en collisions.
    ...
    def move_papa(self) :
        ...
        """ 
        Cette méthode permet de se faire déplacer le méchant bonus de gauche à
        droite.
    ...
    def crea_mechant (self) : 
        """ 
        Cette méthode permet de créer une matrice de méchant.
    ...
    def update_score(self):
        """ 
        Cette méthode sert à actualiser le score du joueur. 
    ...
    def launch_game(self):
        """ 
        Cette méthode permet de lancer une partie. Elle contient tous les appels
    ...
    def main (self):
        ...
        """ 
        Cette méthode permet de mettre en route la fenêtre du jeu.
